  ...
  <div class="max-w-300 mx-auto">
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div flex="~ gap-2 justify-center">
        <a
          href="https://github.com/yaodebian"
          target="_blank"
        ...
        <!-- <a
          href="https://releases.yaodebian.me"
          target="_blank"
    ...
    <!-- <div class="prose pb5 mx-auto mt10 text-center">
      <div block mt-5>
        <a href="https://yaodebian.me/stars-rank" target="_blank" op50>All projects sort by Stars</a>
      </div>
      <hr>
      <SponsorButtons />
    </div> -->
